  ...
  module Tags
    ...
    class Transclude < Liquid::Block
      ...
      def initialize(tag_name, params, tokens)
        super
        @template_name, @params = params.strip.split(/\s+/, 2)
      end
      ...
      def render(context)
        ...
        content = super
        content_html = render_markdown(content) # Convert Markdown to HTML

        # File location
        template_path = File.join(site.source, '_includes', @template_name)
